...
func main() {
	...
	for _, nodeIDHex := range []string{
		"0x479f66c8be895830547e70b4b298cafd433dba6e1ebdfb85",
		"0xde31b4d8b22991d51aa6aa1fc733f23a851a8c9427f780c8",
		"0xe9094f73698002fd52c90819b457b9fbc866ab80727952c7",
		"0xaa18d3991cf637aa6c162f5e95cf163f69cd82913f89fa2e",
		"0xf29bce5f34a74301eb0de716d5194e4a4aea5d7ae0cb875e",
	} {
		//formatting.Encode(formatting.Hex, tx.Bytes())

		nodeIDBytes, err := formatting.Decode(formatting.Hex, nodeIDHex)
		if err != nil {
			log.Fatalf("failed to decode node ID %q: %s\n", nodeIDHex, err)
		}
