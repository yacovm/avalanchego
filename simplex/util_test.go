...
func newEngineConfig(t *testing.T, numNodes uint64) *Config {
	return newNetworkConfigs(t, numNodes, noKeyReuse)[0]
}
...
func newConfigsForQC(t testing.TB, numNodes uint64) []*Config {
...
func newNetworkConfigs(t *testing.T, numNodes uint64, reuseKeys keyReuseOption) []*Config {
	require.Positive(t, numNodes)
