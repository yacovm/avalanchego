...
func (m *ChainVM) SubscribeToEvents(arg0 context.Context, arg1 uint64) (common.Message, uint64) {
	m.ctrl.T.Helper()
...
func (mr *ChainVMMockRecorder) SubscribeToEvents(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubscribeToEvents", reflect.TypeOf((*ChainVM)(nil).SubscribeToEvents), arg0, arg1)
}
