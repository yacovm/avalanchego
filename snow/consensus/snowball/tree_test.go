...
func TestSnowballSingleton(t *testing.T) {
	...
	tree := NewTree(SnowballFactoryInstance, params, Red)
...
func TestSnowballLastBinary(t *testing.T) {
	...
	tree := NewTree(SnowballFactoryInstance, params, zero)
	tree.Add(one)
...
func TestSnowballTrinary(t *testing.T) {
	...
	tree := NewTree(SnowballFactoryInstance, params, Green)
	tree.Add(Red)
	tree.Add(Blue)
...
func TestSnowballCloseTrinary(t *testing.T) {
	...
	tree := NewTree(SnowballFactoryInstance, params, yellow)
	tree.Add(cyan)
	tree.Add(magenta)
...
func TestSnowballResetChild(t *testing.T) {
	...
	tree := NewTree(SnowballFactoryInstance, params, c0000)
	tree.Add(c0100)
	tree.Add(c1000)
...
func TestSnowball5Colors(t *testing.T) {
	...
	tree0 := NewTree(SnowballFactoryInstance, params, colors[4])
	...
	tree1 := NewTree(SnowballFactoryInstance, params, colors[3])
...
func TestSnowballConsistent(t *testing.T) {
	...
	n := NewNetwork(SnowballFactoryInstance, params, numColors, source)
