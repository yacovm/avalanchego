...
func TestDualAlphaOptimization(t *testing.T) {
	...
	singleAlphaNetwork := NewNetwork(SnowballFactoryInstance, params, numColors, source)

	params.AlphaPreference = params.K/2 + 1
	dualAlphaNetwork := NewNetwork(SnowballFactoryInstance, params, numColors, source)
...
func TestTreeConvergenceOptimization(t *testing.T) {
	...
	treeNetwork := NewNetwork(SnowballFactoryInstance, params, numColors, source)
	flatNetwork := NewNetwork(SnowballFactoryInstance, params, numColors, source)
